...
const MovieCard = ({ movie }: { movie: Movie }) => {
  ...
  const year = movie.release_date
    ...
    : movie.first_air_date?.split("-")[0] || "TBA";
    ...
    >
      ...
      >
        <div className="relative h-full w-full rounded-xl overflow-hidden bg-zinc-900 shadow-lg">
          ...
          {badge && (
            <div
              className={`absolute top-2 left-2 z-10 px-3 py-1 text-[10px] md:text-sm font-bold text-white rounded-full shadow-lg backdrop-blur-sm ${
            ...
            >
              ...
              <div className="relative h-32 w-full">
                ...
                <div className="absolute bottom-3 left-3">
                  <button
                    className="bg-white/90 hover:bg-white rounded-full p-2 transition-colors cursor-pointer shadow-lg"
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                ...
                {badge && (
                  <div
                    className={`absolute top-2 right-2 px-2 py-1 text-[10px] font-bold text-white rounded-full ${
