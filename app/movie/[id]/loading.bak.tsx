function loading() {
  return (
    <div className="min-h-screen bg-gray-900 animate-pulse">
      <div className="relative h-[31rem] md:h-[35rem] lg:h-[45rem] bg-gray-700"></div>

      <div className="container mx-auto px-4 lg:-mt-[26rem] sm:-mt-[14rem] md:-mt-[16rem] relative z-10">
        <div className="flex flex-col md:flex-row gap-8">
          {/* Poster Skeleton */}
          <div className="w-auto">
            <div className="relative lg:h-[30rem] sm:h-[18rem] md:[22rem] lg:w-[20rem] sm:w-[12rem] md:w-[16rem] rounded-xl overflow-hidden bg-gray-700"></div>
          </div>
